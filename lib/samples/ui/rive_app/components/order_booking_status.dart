...
class _OrderBookingStatusState extends State<OrderBookingStatus> {
    ...
    if (_selectedShop != null &&
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text('Please select all the required fields.'),
          actions: [
            TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = TextStyle(fontFamily: "avenir next", fontSize: 14);
              ...
              child: SingleChildScrollView(
                ...
                child: SingleChildScrollView(
                  ...
                  child: _showData
                      ? DataTable(
                    columns: [
                      DataColumn(label: Text('Order No', style: textStyle)),
                      ...
                      DataColumn(label: Text('Details', style: textStyle)),
                    ],
                    rows: List<DataRow>.generate(
                      10,
                          (index) => DataRow(
                        cells: [
                          DataCell(Text('Order ${index + 1}', style: textStyle)),
                          DataCell(Text('2024-07-20', style: textStyle)),
                          DataCell(Text('Shop ${index % 3 + 1}', style: textStyle)),
                          DataCell(Text('\$${(index + 1) * 10}', style: textStyle)),
                          DataCell(Text(_statusOptions[index % 4], style: textStyle)),
                          DataCell(Text('Details ${index + 1}', style: textStyle)),
                        ],
                      ),
                    ),
                  )
